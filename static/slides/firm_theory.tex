...
\frame{
	\frametitle{Outline}
	\begin{enumerate}
	\item Motivation: Input decisions
	\item[]
...
\frame{
	\frametitle{Outline}
	\begin{enumerate}
	\item \alert{Motivation: Input decisions}
	\item[]
	\item The production function.
	\item[]
	\item Production: short-run vs. long-run
...
\frame{
	\frametitle{Input decisions}
	\begin{itemize}
	\item How do businesses decide on the mix of labour and capital? labour and fuel? 
	\end{itemize}
}
...
\frame{
	...
	\hline
	1 &	4.0 & 5.7 & 6.9 & \emph{8.0} & 8.9 & 9.8 & 10.6 &	\textbf{11.3} \\
	2 &	5.7 &	 \emph{8.0} & 9.8	& \textbf{11.3} & 12.6 &	 13.9 & 15.0 & 16.0 \\
	3 &	6.9 &	 9.8 & 12.0 & 13.9 & 15.5 & 17.0 & 18.3 &	\underline{19.6} \\
	4 &	\emph{8.0} &	 \textbf{11.3}	 & 13.9 & 16.0 & 17.9 & \underline{19.6} &	21.2 & 22.6 \\
	5 &	8.9 &	 12.6	 & 15.5 & 17.9 & 20.0 & 21.9 & 23.7 & 25.3 \\
	6 &	9.8 &	 13.9	 & 17.0 & \underline{19.6} & 21.9 & 24.0 &	25.9 & 27.7 \\
	7 &	10.6 & 15.0 & 18.3 & 21.2 & 23.7 & 25.9 & 28.0 & 29.9 \\
	8 & 	\textbf{11.3} & 16.0 & \underline{19.6} & 22.6 & 25.3 & 27.7 &  29.9 & 32.0 \\
	\hline
	\end{tabular}
	}
	\end{table}
