...
%  \vfill
  ...
  \begingroup
    ...
    \begin{beamercolorbox}[sep=8pt,center]{title}
      \usebeamerfont{title}BUEC 311: Business Economics, Organization and Management\par%
        \vskip0.05em%
...
%\ifnum\insertpagenumber>1
  \hbox{%
    ...
    \usebeamerfont{headline}\hskip6ptBUEC 311: Estimating Demand and Supply\par%
...
\begin{frame}[fragile]{Elasticity of Demand}
...
\begin{frame}[fragile]{Elasticity along the demand curve}
...
\\[-1.8ex] & \multicolumn{1}{c}{(1)} & \multicolumn{1}{c}{(2)} & \multicolumn{1}{c}{(3)}\\ 
\hline \\[-1.8ex] 
 Constant & 1.845^{***}$ $(0.176) & -1.219^{***}$ $(0.460) & 0.360$ $(1.501) \\ 
  points & 0.065^{***}$ $(0.004) & 0.050^{***}$ $(0.005) & 0.037^{***}$ $(0.013) \\ 
  points2 &  &  & 0.0002$ $(0.0001) \\ 
  toi &  & 0.206^{***}$ $(0.029) & 0.035$ $(0.179) \\ 
  toi2 &  &  & 0.005$ $(0.005) \\ 
 \hline \\[-1.8ex] 
Observations & \multicolumn{1}{c}{440} & \multicolumn{1}{c}{440} & \multicolumn{1}{c}{440} \\ 
Adjusted R$^{2}$ & \multicolumn{1}{c}{0.354} & \multicolumn{1}{c}{0.420} & \multicolumn{1}{c}{0.421} \\ 
Residual Std. Error & \multicolumn{1}{c}{2.087 (df = 438)} & \multicolumn{1}{c}{1.977 (df = 437)} & \multicolumn{1}{c}{1.975 (df = 435)} \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{3}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
